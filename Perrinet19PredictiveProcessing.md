...
Trying to understand vision as an efficiency principle seems like a teleological principle in which causation would be reversed. However, it is one way "by which we may seek to learn how things came to be, and to take their places in the harmonious complexity of the world. " [@DArcy-Thompson17, p.XXX]. Putting this another way, it is not important to know if the brain is bayesian, and that some its part may use Bayes rule explictly, but rather that it offers for a simpler explanation of these complex system.
